...
void initResource() 
{
    ...
    THEME.BUTTON = {248, 186, 200, 255};
    THEME.HOVER_BUTTON = {245, 162, 178, 255};
    THEME.SEPERATOR = {3, 178, 255, 255};
    THEME.INFOR =  {255, 254, 206, 255};
    THEME.HIGHLIGHT_TEXT = {157, 238, 238, 255};
    THEME.HIGHLIGHT_NODE_1 = {55,221,149,255};
    THEME.HIGHLIGHT_NODE_2 = Fade(BLUE,60);
    THEME.NODE = {255, 160, 160, 255}; //{249,208,208,255};
    THEME.LINE = DARKGRAY;
    THEME.SIDEBAR = {250, 254, 255, 255};
    THEME.WEIGHT =  {0, 128, 128, 255}; //{6, 155, 91, 255};
